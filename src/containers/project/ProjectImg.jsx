...
const ProjectImg = ()=>{
    return(
        <svg id="a6dc9487-50e2-4fb9-af91-bf1b7118d463" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                width="700" height="500" viewBox="0 0 1103.79 707.8">
                <defs>
                    <linearGradient id="bd43dd7f-2dfd-4389-bf1e-697a1c0f972b" x1="891.82" y1="790.72" x2="891.82"
                        y2="522.9" gradientUnits="userSpaceOnUse">
                ...
                <g opacity="0.1">
                    <path d="M673.12,122.89c0,156.1,97.93,282.41,219,282.41" transform="translate(-48.1 -96.1)"
                        fill="#0E6BA8">
                    </path>
                </g>
                <path
                    ...
                    transform="translate(-48.1 -96.1)" fill="#0E6BA8" opacity="0.1"></path>
                <path
                ...
                <rect x="598.84" y="170.7" width="70.01" height="33.22" rx="8.57" fill="#0E6BA8" opacity="0.2">
                </rect>
                <polyline points="491.81 203.17 561.89 294.68 634.08 202.74" fill="none" stroke="#001C55"
                ...
                <line x1="492.29" y1="170.7" x2="491.38" y2="138.35" fill="none" stroke="#001C55"
                    stroke-miterlimit="10"></line>
                <polyline points="675.22 139.93 634.08 170.7 590.81 139.93" fill="none" stroke="#001C55"
                    stroke-miterlimit="10">
                </polyline>
                <rect x="456.61" y="106.7" width="70.01" height="33.22" rx="8.57" fill="#0E6BA8" opacity="0.2">
                </rect>
                <rect x="640.21" y="106.7" width="70.01" height="33.22" rx="8.57" fill="#0E6BA8" opacity="0.2">
                </rect>
                <rect x="555.81" y="106.7" width="70.01" height="33.22" rx="8.57" fill="#0E6BA8" opacity="0.2">
                </rect>
                <line x1="561.89" y1="341.51" x2="561.62" y2="430.01" fill="none" stroke="#001C55"
                    stroke-miterlimit="10">
                </line>
                <path d="M609.53,558.59v0Z" transform="translate(-48.1 -96.1)" fill="none" stroke="#001C55"
                    stroke-miterlimit="10"></path>
                <polyline points="462.42 493.11 561.42 462.48 660.82 492.89" fill="none" stroke="#001C55"
                    stroke-miterlimit="10"></polyline>
                <rect x="526.62" y="430.01" width="70.01" height="33.22" rx="8.57" fill="#0E6BA8" opacity="0.2">
                </rect>
                <rect x="861.88" y="345.12" width="70.01" height="33.22" rx="8.57"
                    transform="translate(1210.51 -631.25) rotate(90)" fill="#0E6BA8" opacity="0.2"></rect>
                <rect x="861.88" y="454.76" width="70.01" height="33.22" rx="8.57"
                    transform="translate(377.41 1272.15) rotate(-90)" fill="#0E6BA8" opacity="0.2"></rect>
                <rect x="625.82" y="492.66" width="70.01" height="33.22" rx="8.57" fill="#0E6BA8" opacity="0.2">
                </rect>
                <rect x="475.52" y="588.76" width="70.01" height="33.22" rx="8.57"
                    transform="translate(972.95 1114.65) rotate(-180)" fill="#0E6BA8" opacity="0.2"></rect>
                <rect x="576.46" y="588.76" width="70.01" height="33.22" rx="8.57"
                    transform="translate(1174.83 1114.65) rotate(-180)" fill="#0E6BA8" opacity="0.2"></rect>
                <line x1="801" y1="320.45" x2="832.16" y2="374.94" fill="none" stroke="#001C55"
                    stroke-miterlimit="10"></line>
                <line x1="735.11" y1="319.78" x2="767.82" y2="319.78" fill="none" stroke="#001C55"
                    stroke-miterlimit="10">
                </line>
                <line x1="613.23" y1="317.15" x2="702.51" y2="319.78" fill="none" stroke="#001C55"
                    stroke-miterlimit="10">
                </line>
                <line x1="832.16" y1="265.63" x2="801.15" y2="320.21" fill="none" stroke="#001C55"
                    stroke-miterlimit="10">
                </line>
                <rect x="732.22" y="399.07" width="70.01" height="33.22" rx="8.57"
                    transform="translate(1134.8 -447.65) rotate(90)" fill="#0E6BA8" opacity="0.2"></rect>
                <rect x="797.48" y="399.94" width="70.01" height="33.22" rx="8.57"
                    transform="translate(1200.94 -512.04) rotate(90)" fill="#0E6BA8" opacity="0.2"></rect>
                <rect x="288.1" y="345.12" width="70.01" height="33.22" rx="8.57"
                    transform="translate(636.73 -57.48) rotate(90)" fill="#0E6BA8" opacity="0.2"></rect>
                <rect x="288.1" y="454.76" width="70.01" height="33.22" rx="8.57"
                    transform="translate(-196.37 698.37) rotate(-90)" fill="#0E6BA8" opacity="0.2"></rect>
                <line x1="322.78" y1="320.45" x2="291.61" y2="374.94" fill="none" stroke="#001C55"
                    stroke-miterlimit="10">
                </line>
                <line x1="388.66" y1="319.78" x2="355.96" y2="319.78" fill="none" stroke="#001C55"
                    stroke-miterlimit="10">
                </line>
                <line x1="510.55" y1="317.15" x2="421.27" y2="319.78" fill="none" stroke="#001C55"
                    stroke-miterlimit="10">
                </line>
                <line x1="291.61" y1="265.63" x2="322.62" y2="320.21" fill="none" stroke="#001C55"
                    stroke-miterlimit="10">
                </line>
                <rect x="417.76" y="399.07" width="70.01" height="33.22" rx="8.57"
                    transform="translate(820.34 -133.18) rotate(90)" fill="#0E6BA8" opacity="0.2"></rect>
                <rect x="352.49" y="399.94" width="70.01" height="33.22" rx="8.57"
                    transform="translate(755.94 -67.05) rotate(90)" fill="#0E6BA8" opacity="0.2"></rect>
                <path d="M156.12,598c0,50.24,31.52,90.9,70.47,90.9" transform="translate(-48.1 -96.1)"
                    fill="#46455b"></path>
                <path d="M226.59,688.89c0-50.81,35.18-91.92,78.65-91.92" transform="translate(-48.1 -96.1)"
                    fill="#0E6BA8">
                </path>
                <path d="M181.66,602.55c0,47.72,20.1,86.34,44.93,86.34" transform="translate(-48.1 -96.1)"
                    fill="#0E6BA8">
                </path>
                <path d="M226.59,688.89c0-64.92,40.66-117.45,90.9-117.45" transform="translate(-48.1 -96.1)"
                    fill="#46455b">
                </path>
                ...
                <path
                    ...
                    transform="translate(-48.1 -96.1)" fill="#a8a8a8"></path>
                <path
                    ...
                    transform="translate(-48.1 -96.1)" opacity="0.2"></path>
                <path
                    ...
                    transform="translate(-48.1 -96.1)" fill="url(#bd43dd7f-2dfd-4389-bf1e-697a1c0f972b)"></path>
                <path
                    ...
                    transform="translate(-48.1 -96.1)" fill="#65617d"></path>
                <path
                    d="M974.89,750.5s-3.59,21.65-21.79,24.86-78.94,2.56-78.94,2.56-34.73-5-47.29-34.34-20.63-41-9.87-41.53,68.82,19.61,72.15,19.87S978.09,677.32,974.89,750.5Z"
                    transform="translate(-48.1 -96.1)" opacity="0.05"></path>
                <path
                ...
                <path
                    ...
                    transform="translate(-48.1 -96.1)" opacity="0.1"></path>
                <path
                ...
                <path
                    ...
                    transform="translate(-48.1 -96.1)" fill="#ee8e9e"></path>
                <path
                    ...
                    transform="translate(-48.1 -96.1)" fill="#e3e8f4"></path>
                <path
                ...
                <path
                    ...
                    transform="translate(-48.1 -96.1)" opacity="0.1"></path>
                <path d="M866.21,570.57a29.35,29.35,0,1,0,.64-6.1A29.35,29.35,0,0,0,866.21,570.57Z"
                    transform="translate(-48.1 -96.1)" fill="#ee8e9e"></path>
                <path
                    ...
                    transform="translate(-48.1 -96.1)" fill="#001C55"></path>
                <path d="M823.41,669.12s-15.64-22.56-27.3-10.38,4.74,31.91,8.59,31.27,22.17-1.67,22.17-1.67Z"
                    transform="translate(-48.1 -96.1)" fill="#ee8e9e"></path>
                <rect x="770.4" y="638.26" width="81.83" height="63.54" rx="1.54"
                    transform="translate(345.12 -391.66) rotate(27.04)" fill="#001C55"></rect>
                <rect x="777.03" y="644.03" width="68.78" height="51.83"
                    transform="translate(345.09 -391.72) rotate(27.04)" fill="#0E6BA8"></rect>
                ...
                <path
                    ...
                    transform="translate(-48.1 -96.1)" fill="#565387"></path>
                <path
                    d="M919.14,772.92c.27,6.46,5.3,14.48,8.3,18.72,1.9,0,3.36-.13,3.36-.13s-1.17-31.2-2-34.48c-.42-1.57-2.5-1.22-4.54-.44C921.73,761.24,918.92,767.72,919.14,772.92Z"
                    transform="translate(-48.1 -96.1)" opacity="0.1"></path>
                <path
                ...
                <g opacity="0.1">
                    <path
                        ...
                        transform="translate(-48.1 -96.1)"></path>
                    <path
