...
const ExperienceImg = ()=>{
    return(
        <svg id="bf56719a-dd30-4b09-833f-7c41eeee086b" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                width="700" height="500" viewBox="0 0 1094 760">
                <title>career process</title>
                <rect x="155" y="304.52" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="291.81" y="344.05" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="428.63" y="383.57" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="155" y="245.24" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="291.81" y="284.76" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="428.63" y="324.29" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="580.64" y="304.52" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="717.45" y="344.05" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="854.27" y="383.57" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="580.64" y="245.24" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="717.45" y="284.76" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="854.27" y="324.29" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="155" y="166.19" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="291.81" y="205.71" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="428.63" y="245.24" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="155" y="106.9" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1"></rect>
                <rect x="291.81" y="146.43" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="428.63" y="185.95" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="580.64" y="166.19" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="717.45" y="205.71" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="854.27" y="245.24" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="580.64" y="106.9" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="717.45" y="146.43" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <rect x="854.27" y="185.95" width="130.73" height="39.52" rx="7.43" fill="#0E6BA8" opacity="0.1">
                </rect>
                <ellipse cx="547" cy="660.5" rx="547" ry="99.5" fill="#0E6BA8" opacity="0.1"></ellipse>
                <polygon points="240 321 194 603 402 581 393 557 230.5 570.5 268.5 320.5 240 321" fill="#001C55">
                </polygon>
                <polygon points="186 1 466 0 547 613 266 651 186 1" fill="#001C55"></polygon>
                <polygon points="216.5 24.5 442.5 24.5 521.5 594.5 288.5 626.5 216.5 24.5" fill="#fff"></polygon>
                <path
                    ...
                    transform="translate(-53 -70)" fill="#001C55"></path>
                <path
                ...
                <path
                    ...
                    transform="translate(-53 -70)" fill="#00072D"></path>
                <path
                    ...
                    transform="translate(-53 -70)" fill="#fbbebe"></path>
                ...
                <path
                    ...
                    transform="translate(-53 -70)" fill="#f2f2f2"></path>
                <path
                    ...
                    transform="translate(-53 -70)" fill="#0E6BA8"></path>
                <path
                ...
                <path
                    ...
                    transform="translate(-53 -70)" fill="#fff"></path>
                <path
                ...
                <path
                    d="M682.09,501.78c-4,23.23-1.39,47.1,3.11,70.23a122.46,122.46,0,0,0,3.27,13.64c1.61,5.1,3.78,10,5.29,15.13,3.84,13,3.3,26.9,2.73,40.47L693.87,703c-.22,5.18-.42,10.48,1.14,15.42.63,2,1.4,4.5-.19,5.85a4.46,4.46,0,0,1-2.11.81,32.66,32.66,0,0,1-21-3.15L671,659.55c-.22-19.23-.45-38.54-3.41-57.53-2.35-15.1-6.43-30-6.7-45.28-.28-16,3.64-31.79,7.64-47.3.86-3.32,4-5.75,6.58-8a8.09,8.09,0,0,1,3.2-1.94C679.51,499.17,681.35,500.77,682.09,501.78Z"
                    transform="translate(-53 -70)" opacity="0.1"></path>
                <path
